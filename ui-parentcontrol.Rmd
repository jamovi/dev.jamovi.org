...
If the control is also a Display Control (e.i. `RadioButton` or `CheckBox`) another property is avaliable.
...
The following controls are examples of parent controls.
