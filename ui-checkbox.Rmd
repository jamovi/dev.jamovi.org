...
**Inherits from `OptionControl`, `ParentControl`**

## Properties

There are no `CheckBox` specific properties. All behavior can be achieved using the inherited properties of [`OptionControl`](ui-optioncontrol.html) and [`OptionControl`](ui-optioncontrol.html).
