...
> [!NOTE]
> The `optionName` property of the `CheckBox` is not specified and therefore the *option binding* will use the `name` property of the control for the binding process instead (see [OptionControl](/ui/optioncontrol) for more details).
