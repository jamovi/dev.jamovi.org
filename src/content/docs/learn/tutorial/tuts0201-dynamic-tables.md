...
![Jamovi screenshot](@assets/learn/tutorial/dynamic-tables-final.png)
...
![Jamovi screenshot](@assets/learn/tutorial/dynamic-tables-ui.png)
...
![Jamovi screenshot](@assets/learn/tutorial/dynamic-tables-blank.png)
...
![Jamovi screenshot](@assets/learn/tutorial/dynamic-tables-bound.png)
...
We can now reinstall the module using `jmvtools::install()`. 

> [!NOTE]
> This analysis will not work if you specify a nominal or ordinal variable as a dependent. So be sure to either use a continuous variable, or change the type of the variable to continuous before assigning it as a dependent. We will look at the correct way to handle nominal and ordinal variables in the next tutorial.
