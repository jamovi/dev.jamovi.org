...
We've just released a beta of jamovi 0.7.3 (available from [here](https://www.jamovi.org/download.html)), which brings some significant improvements, and minor changes to developing jamovi modules. In order to continue developing, we encourage you to download and begin using the new jamovi beta, and the latest version of jmvtools.
