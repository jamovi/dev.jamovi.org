...
Here you will find resources that cover the development of analyses for jamovi (and R).

There are forums available at [forum.jamovi.org](https://forum.jamovi.org), so if you have questions about developing modules for jamovi, we're keen to hear from you there.
...
The 2.7.16 version of jamovi introduces image sizing

[Image sizing](api_image-sizing.html)

### 11-11-2025

The 2.7.12 version of jamovi introduces the new analysis action system

[Analysis actions](api_actions.html)

### 08-03-2024

The 2.5 series of jamovi is out. This updates the R version to 4.3.2, and moves the snapshot forward to 2024-01-09.

The 2.5 series improves support for computers using ARM CPUs such as Chromebooks and the new "Apple Silicon" Macs. Note that modules are (typically) not portable between operating systems or architectures, so separate modules will need to be built for each.
